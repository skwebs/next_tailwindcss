    ...
    <>
      <div className={`${wrapperClass} pt-2`}  >
        <div className={`${inputWrapperClass} h-10 relative z-0`}>
          <input {...inputAtt} type="text" id={id} className={`${className} h-full  block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 dark:border-gray-600 appearance-none dark:text-white focus:outline-none focus:ring-0 peer`} placeholder=" " />
