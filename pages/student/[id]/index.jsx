                  ...
                  <div className="w-[600px]">
                    <div className="flex">
                      <div className="w-2/3">
                        <table className="table text-left whitespace-nowrap">
                          <tbody>
                            <tr><th className="pr-2 py-2 w-48">Father's Name</th><td>: {apiData.father_name}</td></tr>
                            <tr><th className="pr-2 py-2">Father's Contact</th><td>: {apiData.father_contact}</td></tr>
                            <tr><th className="pr-2 py-2">Father's Qualification</th><td>: {apiData.father_qualification}</td></tr>
                            <tr><th className="pr-2 py-2">Father's Occupation</th><td>: {apiData.father_occupation}</td></tr>
                            <tr><th className="pr-2 py-2">Father's Annual Income</th><td>: {apiData.father_annual_income}</td></tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <div className="flex">
                      <div className="w-2/3">
                        <table className="table text-left whitespace-nowrap">
                          <tbody>
                            <tr><th className="pr-2 py-2 w-48">Mother's Name</th><td>: {apiData.mother_name}</td></tr>
                            <tr><th className="pr-2 py-2">Mother's Contact</th><td>: {apiData.mother_contact}</td></tr>
                            <tr><th className="pr-2 py-2">Mother's Qualification</th><td>: {apiData.mother_qualification}</td></tr>
                            <tr><th className="pr-2 py-2">Mother's Occupation</th><td>: {apiData.mother_occupation}</td></tr>
                            <tr><th className="pr-2 py-2">Mother's Annual Income</th><td>: {apiData.mother_annual_income}</td></tr>
                          </tbody>
                        </table>
                      </div>
                      <div className="w-1/3 pl-2 pb-2">
